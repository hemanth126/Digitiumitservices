...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/com/dis/bulkorderinsertion/ProcessTest.java) in your IDE or using:
...
```bash
java -jar target/bulk-order-insertion.jar
```
